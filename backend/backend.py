...
def generate_gtts_voiceover(meditation_text, user_name, voice_name = "Rachel"):
    """Generates a voiceover from meditation text
    ...
    user_name : str
        The user's name.
    """
    gtts_audio = gTTS(meditation_text, lang='en', slow=False)
    current_dir = Path(__file__).parent
    mp3_file_path = current_dir / "audio_files" / f"{user_name}_meditation.mp3"
    gtts_audio.save(str(mp3_file_path))
    return mp3_file_path
